        ...
        <>
            ...
            <main className="main-wrapper">
                ...
                <div className="section">
                        ...
                        <div className="row">
                            <div className="col-xl-5 col-lg-6">
                                ...
                                <div className="contact-info mb--30">
                                    ...
                                    <h4 className="phone-number"><a href="tel:1234567890">
                                    +91 97399 06066</a></h4>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-xl-5 col-lg-6">
                                ...
                                <div className="contact-info mb--30">
                                    ...
                                    <h4 className="phone-number"><a href="#">
                                        Bengaluru</a></h4>
                                </div>
                            </div>
                            <div className="col-xl-5 col-lg-6 offset-xl-1">
                                ...
                                <div className="contact-info mb--30">
                                    ...
                                    <p>Sunday Closed</p> 
                                    <br></br>
                                    <h4 className="phone-number"><a href="mailto:info@example.com">
                                    Mon - Sat: 8AM - 5PM
                                    </a></h4>
                                </div>
                            </div>
                    ...
                    <li className="shape shape-1"><img src={PUBLIC_URL + "/images/others/bubble-2.png"} alt="Bubble" /></li>
                    <li className="shape shape-2"><img src={PUBLIC_URL + "/images/others/bubble-1.png"} alt="Bubble" /></li>
                    <li className="shape shape-3"><img src={PUBLIC_URL + "/images/others/circle-3.png"} alt="Circle" /></li>
                </ul> */}
                </div>
